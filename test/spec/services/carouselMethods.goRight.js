...
describe('Service: carouselMethods.goRight', function() {
  ...
  it('Call the goRight method and check the result values', function() {
    ...
    carouselMethods.goRight(scope, element, onEndCb);
    ...
    expect(scope.nextBox.css('visibility')).toBe('');
    expect(scope.containerUlElement.css('left')).toBe('-' + (800 * 2) + 'px');
