...
describe('Service: carouselMethods.transitionRightEnd', function() {
  ...
  it('Call the goRight method and check the result values', function() {
    ...
    carouselMethods.goLeft(scope, element, carouselMethods.transitionRightEnd);
    ...
    expect(scope.currentBox).toEqual(tmpNextBox);
    expect(scope.prevBox).toEqual(tmpCurrentBox);
    expect(scope.nextBox).not.toEqual(null);
